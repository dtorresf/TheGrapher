...
class SSHSession(object):
    ...
    def __init__(self,hostname,username='root',key_file=None,password=None):
        ...
        try:
            ...
            print("Couldnt connect with the first node of exalogic " + hostname + " . Server not known")
            sys.exit(1)
        except socket.error:
            print("Couldnt connect with the first node of especified exalogic node: " + hostname + " .Please verify config file")
            sys.exit(1)
    ...
    def sftp_walk(self,remotepath):
        ...
        try:
            ...
            print("ERROR: Remote data directory does not exists, please check config file variables")
            sys.exit(1)
